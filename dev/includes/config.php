...
\*-----------------------------------------------------------*/
    ...
    $_CONF['data']['user'] = "ispecws"; //Your database user, most use 'root' anyway.
    $_CONF['data']['pass'] = "1o7Gfour10"; //Password for user, duh! :)
    $_CONF['data']['name'] = "ispecws_scms"; //Now to name your database.. You uploaded a database right?
    
    /* Website setup */
    $_CONF['web']['name'] = "Scorch"; //The name of your hotel.
    $_CONF['web']['link'] = "http://se-gm.com/prj/sCMS"; //Link your hotel. No ending slash (/)!
